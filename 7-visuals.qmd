...
library("ggplot2")
```
```{r,t8.5, eval = TRUE, echo = FALSE, message=FALSE, warning=FALSE}
library("ggplot2")
```
...
- Hehman, E., & Xie, S. Y. (2021). Doing Better Data Visualization. _Advances in Methods and Practices in Psychological Science_. DOI: 10.1177/25152459211045334 [Link](https://doi.org/10.1177/25152459211045334)
