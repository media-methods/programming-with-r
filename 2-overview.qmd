...
R projects therefore work with absolute instead of relative paths: Instead of having to set your working directory manually (e.g., `setwd(Desktop/Data`)), R projects simply run from the folder where the project lies automatically. Any files in this folder (or in subfolders) can thus be accessed. 
...
-   **No more “file not found” drama:** YouR project folder becomes the default location, so loading files is simpler.
...
-   **Collaboration-friendly:** A shared project structure makes it easier for others to run your code on their computer.
...
For this class, I recommend using the following structure:
