...
![](files/images/5_tidyverse.jpg){fig-alt="Overview of the tidyverse"} To install and load the core tidyverse packages:
...
-   `mutate()`: create new columns or overwrite existing ones, for example using `case_when()`
