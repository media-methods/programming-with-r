...
R is the programming language we'll use to import, edit, and analyze data. Please use [Cran](https://cran.r-project.org/) to install the newest version of R (version 4.3.1, "Beagle Scouts"). You'll have to specify your operation system to download the right version:
...
Next, install R Studio. R Studio is a desktop application with a graphical interface that facilitates programming with R. The newest version of R Studio (2023-09-28) can be downloaded via this [Link](https://www.rstudio.com/products/rstudio/download/#download).
