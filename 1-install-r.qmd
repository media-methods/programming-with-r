...
format:
  html:
    html-math-method: katex   # irrelevant, but keeps format block explicit
    include-in-header: []     # ensures format block is honored
---
...
<!-- giscus will appear below -->
<div class="giscus"></div>

<script src="https://giscus.app/client.js"
        data-repo="media-methods/programming-with-r"
        data-repo-id="R_kgDORaPluQ"
        data-category="FAQ R"
        data-category-id="DIC_kwDORaPluc4C3Uwp"
